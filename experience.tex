...
\begin{cventries}
	...
	{\iflanguage{german}{Mai 2025 -- heute}{May 2025 -- Present}} % Date(s)
	{
		\begin{cvitems}
			...
			\item {
				\iflanguage{german}
				{Technisches Agile Coaching zu Engineering-Praktiken wie TDD, CI/CD, Pair-/Mob Programming sowie KI-unterstütztes Entwickeln und Unterstützung bei der nachhaltigen Einführung im Alltag.}
				{Provided technical agile coaching on engineering practices such as TDD, CI/CD, pair/mob programming, and AI augmented coding and supported sustainable day-to-day adoption.}
			}
		\end{cvitems}
	}
\end{cventries}
