...
\iflanguage{german}
{
	...
	Mit meinem Hintergrund als Softwareentwickler bringe ich eine Perspektive mit, die es mir ermöglicht, Entwickler zu verstehen und effektive Verbesserungen in technischen Praktiken vorzuschlagen. Ob es darum geht, Teams bei der Einführung von eXtreme Programming (XP)-Prinzipien (inkl. Test-Driven Development (TDD) sowie Pair-/Mob Programming) zu unterstützen oder CI/CD- und DevOps-Fähigkeiten weiterzuentwickeln – ich habe praktische Erfahrung in der Umsetzung solcher Veränderungen.  
...
}
{
	...
	While my recent roles where not primarily focused on coding, I continue to identify as a developer. Through my work on \underline{\href{https://github.com/LetPeopleWork/Lighthouse}{Lighthouse}}, I actively practice TDD, CI/CD, and pair/mob programming.
	
	Automation of anything and everything is another passion of mine. Whether it's a script that can collect some data automatically, or \underline{\href{https://github.com/huserben/cv/actions}{a CI/CD pipeline for this CV}}, it's something I genuinely enjoy doing.
}
\end{cvparagraph}
