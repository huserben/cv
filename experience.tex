...
\begin{cvparagraph}
	\iflanguage{german}
	{
		Mitgründer und Vorsitzender der Geschäftsführung seit Mai 2025.\newline
			extit{LetPeopleWork GmbH bietet Beratungs- und Schulungsdienstleistungen in den Bereichen Prozessoptimierung, Projektmanagement, agile Methoden und moderne Softwareentwicklung.}
	}
	{
		Co-Founder and Managing Director since May 2025.\newline
			extit{LetPeopleWork GmbH provides consulting and training services in process optimization, project management, agile methods, and modern software development.}
	}
\end{cvparagraph}
...
\begin{cventries}
	...
	} % Date(s)
	{
		\begin{cvitems}
            ...
            \item {
                \iflanguage{german}
                {Lead Developer und technischer Hauptverantwortlicher für die Entwicklung und den Betrieb der Lighthouse Softwarelösung.}
                {Lead developer and technical owner for the development and operation of the Lighthouse software solution.}
            }
		\end{cvitems}
	}
\end{cventries}
